...
Route::get('/orders/{order}', [OrderController::class, 'showOrderDetails'])->middleware(['auth'])->name('orders.show');
    ...
    Route::get('/product',Products::class)->middleware(['auth', 'verified','IsAdmin'])->name('product');
    Route::get('/product/create',CreateProduct::class)->middleware(['auth', 'verified','IsAdmin'])->name('product.create');
    Route::get('/product/edit/{id}',UpdateProduct::class)->middleware(['auth', 'verified','IsAdmin'])->name('product.edit');
